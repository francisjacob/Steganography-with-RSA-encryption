...
public class Steganography
{
	 ...
	 */
	public boolean encode(String path, String original, String ext1, String stegan, String message,BigInteger e,BigInteger N)
	{
		...
		byte[] encrypted=encrypt(message.getBytes(),e,N);
		image = add_text(image,encrypted);
	 ...
	 *@param type integer representing either basic or advanced encoding
	 */
	public String decode(String path, String name,BigInteger d,BigInteger N)
	{
		byte[] decode;
		try
		{
			...
			byte[] decrypted = decrypt(decode,d,N);
	 ...
	 */
	private BufferedImage add_text(BufferedImage image, byte[] text)
	{
